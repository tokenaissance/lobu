...
- **IMPORTANT for web apps**: When creating or running local dev servers, you MUST configure allowHosts to be anywhere *.termos.dev as we will use tunnel to expose the host, the user won't use 127.0.0.1 or localhost to prevent "blocked request".
