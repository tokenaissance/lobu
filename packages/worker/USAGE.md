...
This document describes all environment variables used by Termos Workers. Most of these are automatically set by the Gateway orchestrator and should not be manually configured.
...
**Format**: `termos-worker-{user}-{timestamp}-{random}`
**Example**: `termos-worker-u123abc-284-707819`
**Set by**: Gateway orchestrator
...
### `TERMOS_DATABASE_NAME`
**Description**: PostgreSQL database name
**Format**: String
**Set by**: Gateway orchestrator
**Used by**: Database connections

### `TERMOS_DATABASE_USER`
**Description**: PostgreSQL username
**Format**: String
**Set by**: Gateway orchestrator
**Used by**: Database authentication

### `TERMOS_DATABASE_PASSWORD`
...
DEPLOYMENT_NAME=termos-worker-<user>-<timestamp>
HOME=/workspace
```
