...
After `init`, your project is configured through `lobu.toml`. Use the CLI to add providers, and use `npx skills` to install public skills when needed:
...
# Install the Owletto skill separately
