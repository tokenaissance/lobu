...
Those commands install the repo's public skills through `npx skills`. With the OpenClaw target, they materialize local `skills/` folders you can commit, customize, and let your runtime discover like any other local skill.
